...
extract($_REQUEST);
$rdate=date("d-m-Y");
$q1=mysqli_query($connect,"select * from fees where id=1");
$r1=mysqli_fetch_array($q1);
if(isset($btn))
{
mysqli_query($connect,"update fees set fees='$fees',rdate='$rdate',details='$details' where id=1");
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="478" border="1" align="center">
    <tr>
      <th>Hostel &amp; Mess Fees (Declared on <?php echo $r1['rdate']; ?>) </th>
    </tr>
