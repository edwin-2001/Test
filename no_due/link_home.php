...
<div class="subhead">
	<ul id="menu">
	   ...
	   <li><a href="login.php" onMouseOver="mopen('m2')" onMouseOut="mclosetime()">HOSTEL</a>
	  
	   </li>
	   <li><a href="login3.php" onMouseOver="mopen('m2')" onMouseOut="mclosetime()">LIBRARY</a>
	   <li><a href="login2.php" onMouseOver="mopen('m2')" onMouseOut="mclosetime()">OFFICE</a>
