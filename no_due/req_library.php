...
if($act=="ok")
{
mysqli_query($connect,"update students set st_library=2 where id=$uid");
?>
<script language="javascript">
alert("Updated Success..");
window.location.href="req_library.php";
</script>
<?php
}
...
<form id="form1" name="form1" method="post" action="">
  ...
  $qry=mysqli_query($connect,"select * from students where st_library=1");
  ...
  <table width="983" border="1" align="center">
    ...
    <tr>
      ...
      <td><a href="req_library.php?act=ok&uid=<?php echo $row['id']; ?>">Due Clear</a> | 
	  <a href="req_library.php?act=no&uid=<?php echo $row['id']; ?>">Due Pending</a> </td>
