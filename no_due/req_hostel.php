...
if($act=="ok")
{
mysqli_query($connect,"update students set st_hostel=2 where id=$uid");
?>
<script language="javascript">
alert("Updated Success..");
window.location.href="req_hostel.php";
</script>
<?php
}
if($act=="no")
{
mysqli_query($connect,"update students set st_hostel=3 where id=$uid");
?>
<script language="javascript">
alert("Updated Success..");
window.location.href="req_hostel.php";
...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>&nbsp;</p>
  <h2 align="center">Welcome to Hostel Warden </h2>
  <h3 align="center">Student Request </h3>
  <p align="center">
    <?php
  
  $qry=mysqli_query($connect,"select * from students where st_hostel=1");
  ...
  <table width="983" border="1" align="center">
    ...
    <tr>
      ...
      <td><a href="req_hostel.php?act=ok&uid=<?php echo $row['id']; ?>">Due Clear</a> | 
	  <a href="req_hostel.php?act=no&uid=<?php echo $row['id']; ?>">Due Pending</a> </td>
    </tr>
    <?php
	}
	?>
